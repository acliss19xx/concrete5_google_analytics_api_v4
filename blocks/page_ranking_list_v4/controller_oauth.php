...
*/
    ...
    private function analyticsInitialize(){
        ...
        if (isset($_SESSION['access_token_ga']) && $_SESSION['access_token_ga']) {
          var_dump($_SESSION['access_token_ga']);
          // Set the access token on the client.
          $client->setAccessToken($_SESSION['access_token_ga']);
...
//          return $this->printResults($response);
          ...
          $redirect_uri = rtrim((string) $this->app->make('url/canonical'), '/') . '/index.php/oauth2callback';
